...
import {
    getCaseHistory,
} from '@/features/cases/case-history.service';
import {
    ...
    >(() => {
        ...
        return [
            ...
            (firstItem, secondItem) =>
                secondItem.date.toMillis() -
                firstItem.date.toMillis()
        );
            ...
            <FlatList
                ...
                ListEmptyComponent={
                    ...
                    >
                        ...
                        >
                            Aucun événement ni aucune activité
                            n’a encore été enregistré pour ce
                            dossier.
                        </Text>
                    </View>
                }
